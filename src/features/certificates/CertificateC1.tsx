      ...
      <Box bg="linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(255,46,46,0.835171568627451) 0%, rgba(255,179,0,1) 100%);">
        <Container maxW={"6xl"} py="120px">
          <Heading
            ...
            color={"white"}
          >
            Thông tin từ A-Z về kỳ thi cấp bằng C1 tiếng Anh năm 2023
          </Heading>
          <Text
            textAlign={"center"}
            size={"sm"}
      ...
      <Container maxW={"6xl"} py="46px">
        ...
        <SimpleGrid columns={{ base: 1, lg: 1 }} gap={"24px"}>
          <Box pt={"42px"}>
            ...
            <Box>
              <Text>
                Trước tiên, hãy xem bằng B1 tiếng Anh là gì? Bằng C1 tiếng Anh
                là chứng chỉ tiếng Anh C1 chứng nhận người sở hữu có trình độ
                tiếng Anh C1 theo khung châu Âu hoặc khung năng lực Ngoại ngữ 6
